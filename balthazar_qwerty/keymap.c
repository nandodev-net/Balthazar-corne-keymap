...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // -----------------------------------------------------------------------
  // LAYER 0 - QWERTY
  // Base layer. LSFT_T(TAB): tap=Tab / hold=Shift
  // Left thumb:  GUI | Navigate(hold) | Space/Numpad(hold)
  // Right thumb: Space | Enter/Symbols(hold) | Alt
  // -----------------------------------------------------------------------
    [0] = LAYOUT_split_3x6_3(
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
       KC_ESC,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                         KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,  KC_BSPC,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  LSFT_T(KC_TAB),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                         KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_ENT,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  // ┌─────────────────────────────────────────────────────────────────────┐
  // │ LAYER 2 — SYMBOLS                                                   │
  // │ Hold right inner thumb LT(2,ENT). Left hand types symbols.          │
